...
public class Graph {
	...
	public boolean pathExists(Vertex u, Vertex v) {
		PathComponent pc = new PathComponent(this);
		pc.start();
		return pc.comps.get(u) == pc.comps.get(v);
	}
	...
	public boolean hasCycle() {
		CycleComponent cycleComponent = new CycleComponent(this);
		return cycleComponent.edges.size() >= cycleComponent.vertices.size();
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Checking Adjacent - Vertex "+v1+" and Vertex "+v2+": "+g.areAdjacent(v1,v2));
		System.out.println("Is graph connected? : "+g.isConnected());
		System.out.println("Checking Path - Vertex "+v1+" and Vertex "+v3+": "+g.pathExists(v1,v3));
		System.out.println("Checking Cycle : " + g.hasCycle());
		System.out.println("There is/are "+g.numConnectedComponents()+" connected component(s) in graph");
		System.out.println("Calculate Shortest path from "+v1+" to "+v3+" : "+g.shortestPathLength(v1,v3));
